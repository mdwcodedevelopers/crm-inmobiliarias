<template>
    <div>
        ...
        <v-data-table :headers="headers"  no-results-text="No hay resultados" no-data-text="No hay datos disponibles" :items="status" item-key="propeties-user" class="elevation-1" :search="search">
            <template v-slot:top>
